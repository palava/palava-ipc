 ...
 */
public class IpcArgumentsMissingException extends RuntimeException {

    private static final long serialVersionUID = -4016565094430756701L;

    public IpcArgumentsMissingException(String argument) {
        super(argument);
    }

    public IpcArgumentsMissingException(Throwable cause) {
        super(cause);
    }
